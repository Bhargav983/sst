...
import { Mail, Phone, MapPin, Facebook, Instagram, Twitter, ChefHat } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              ...
              {/* You can add more static links here, e.g., to an About Us page or FAQ page if they exist */}
